...
1. A player loose his ENTIRE score when he rolls two 6 in a row. After that, it's the next player's turn. (Hint: Always save the previous dice roll in a separate variable.)
...
3. Add another dice to the game, so that there are two dices now. The player loose his current score when one of them is a 1. (Hint: You will need CSS to position the second dice, so take a look at the CSS code for the first one.)
*/
...
document.querySelector('.btn-roll').addEventListener('click', function() {
    if (gamePlaying) {
        ...
        if (dice === 6 && lastDice === 6) {
            // If player rolls 6 twice in a row, loses score
